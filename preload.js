...
contextBridge.exposeInMainWorld('desktopAPI',{
 ...
 schoolAsk:x=>ipcRenderer.invoke('school-ask',x), researchAsk:x=>ipcRenderer.invoke('research-ask',x),researchAgent:x=>ipcRenderer.invoke('research-agent',x),compareAssets:x=>ipcRenderer.invoke('compare-assets',x),portfolioInsight:x=>ipcRenderer.invoke('portfolio-insight',x),identifyAsset:x=>ipcRenderer.invoke('identify-asset',x), planAsk:x=>ipcRenderer.invoke('plan-ask',x),
